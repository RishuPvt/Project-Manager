...
const ProfilePage: React.FC = () => {
  ...
  const userOrganization = organizations.find(org => org.id === user?.organizationId);
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-3 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-gray-900 dark:text-white">{userOrganization.name}</p>
