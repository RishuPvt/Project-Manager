...
const SettingsPage: React.FC = () => {
  ...
  // Add demo user if no user exists
  if (!user) {
    setUser({
      id: 1,
      name: "Demo User",
                      ...
                      <div key={field}>
                        ...
                        <div className="relative">
                          <input
                            ...
                            value={passwordData[`${field}Password` as keyof typeof passwordData]}
                            onChange={(e) =>
                              setPasswordData({
                                ...passwordData,
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full mx-4">
              <div className="p-6">
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6">
                  Are you sure you want to leave your organization? You will lose access
                  to all projects and need to request access again.
                </p>
